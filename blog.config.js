...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '8fc5423259b848c8bd1fc16986e1d874',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Camellia', // 您的昵称 例如 tangly1024
  ...
  POST_WAITING_TIME_FOR_404: process.env.NEXT_PUBLIC_POST_WAITING_TIME_FOR_404 || '60', // 文章加载超时时间，单位秒；超时后跳转到404页面
